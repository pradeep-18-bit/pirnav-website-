  ...
  return (
    <div className="page-shell">
      ...
      <CTASection
        ...
        title={service.ctaTitle || `Talk to Pirnav about ${service.title.toLowerCase()}.`}
        description="We help enterprise teams plan, build, modernize, and support technology platforms with a practical consulting-led delivery model."
        primaryAction={{ label: "Start a Conversation", to: "/contact" }}
        secondaryAction={{ label: "All Services", to: "/services" }}
      />
    </div>
  );
};
